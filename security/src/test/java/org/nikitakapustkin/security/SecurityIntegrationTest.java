...
class SecurityIntegrationTest {
    ...
    static void registerProperties(DynamicPropertyRegistry registry) {
        ...
        String baseUrl = mockServerAvailable && bankServer != null
                ? bankServer.url("/").toString()
                : "http://localhost:0";
        registry.add("bank.base-url", () -> baseUrl);
        registry.add("storage.base-url", () -> baseUrl);
        registry.add("spring.datasource.url", () -> "jdbc:h2:mem:securitytest;MODE=PostgreSQL;DB_CLOSE_DELAY=-1");
    ...
    @BeforeEach
    void setUp() {
        org.junit.jupiter.api.Assumptions.assumeTrue(mockServerAvailable, "MockWebServer not available");
    ...
    void login_and_users_me_flow() throws Exception {
        ...
        String createdAccountJson = objectMapper.writeValueAsString(
                java.util.Map.of(
                        "id", accountId,
                        "ownerId", userId,
                        "balance", 0
        ...
        bankServer.enqueue(new MockResponse()
                .setResponseCode(201)
                .setBody(createdAccountJson)
                .addHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE));

        mockMvc.perform(post("/users/me/accounts")
    ...
    void admin_can_load_events() throws Exception {
        ...
        String eventsJson = objectMapper.writeValueAsString(List.of(
