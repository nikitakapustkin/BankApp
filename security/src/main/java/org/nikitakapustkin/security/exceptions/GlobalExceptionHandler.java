...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleUserHasNoFriendsException(
      UserHasNoFriendsException ex, HttpServletRequest req) {
  ...
  public ResponseEntity<ErrorResponse> handleBankServiceException(
      BankServiceException ex, HttpServletRequest req) {
  ...
  private ResponseEntity<ErrorResponse> build(
    ...
    ErrorResponse body =
        new ErrorResponse(
            Instant.now(), status.value(), error, message, req != null ? req.getRequestURI() : "");
