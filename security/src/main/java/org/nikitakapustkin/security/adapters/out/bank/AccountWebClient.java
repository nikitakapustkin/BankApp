...
public class AccountWebClient implements AccountBankClientPort {
    ...
    public AccountResponseDto createAccount(UUID ownerId) {
        Mono<org.nikitakapustkin.bank.contracts.dto.response.AccountResponseDto> response = webClient.post()
                .uri(BankApiPaths.ACCOUNTS)
                .bodyValue(new org.nikitakapustkin.bank.contracts.dto.request.CreateAccountRequestDto(ownerId))
                .retrieve()
        ...
        org.nikitakapustkin.bank.contracts.dto.response.AccountResponseDto created = support
                .maybeRetry(response, false)
                .block();
    ...
    public List<AccountResponseDto> getUserAccounts(UUID userId) {
        Mono<List<org.nikitakapustkin.bank.contracts.dto.response.AccountResponseDto>> response = webClient.get()
                .uri(BankApiPaths.USER_ACCOUNTS, userId)
                .retrieve()
                .onStatus(HttpStatusCode::isError, support::toBankException)
                .bodyToMono(new ParameterizedTypeReference<>() {
                });
        List<org.nikitakapustkin.bank.contracts.dto.response.AccountResponseDto> accounts = response
    ...
    public void deposit(UUID accountId, DepositRequestDto depositRequest) {
        Mono<ResponseEntity<Void>> response = webClient.post()
                ...
                .bodyValue(new org.nikitakapustkin.bank.contracts.dto.request.DepositRequestDto(
    ...
    public void withdraw(UUID accountId, WithdrawRequestDto withdrawRequest) {
        Mono<ResponseEntity<Void>> response = webClient.post()
                ...
                .bodyValue(new org.nikitakapustkin.bank.contracts.dto.request.WithdrawRequestDto(
    ...
    public void transfer(UUID fromAccountId, TransferRequestDto transferRequest) {
        Mono<ResponseEntity<Void>> response = webClient.post()
                ...
                .bodyValue(new org.nikitakapustkin.bank.contracts.dto.request.TransferRequestDto(
    ...
    public AccountResponseDto getAccountById(UUID accountId) {
        Mono<org.nikitakapustkin.bank.contracts.dto.response.AccountDetailsResponseDto> response = webClient.get()
                .uri(BankApiPaths.ACCOUNT_BY_ID, accountId)
                .retrieve()
                .onStatus(HttpStatusCode::isError, support::toBankException)
                .bodyToMono(org.nikitakapustkin.bank.contracts.dto.response.AccountDetailsResponseDto.class);
        org.nikitakapustkin.bank.contracts.dto.response.AccountDetailsResponseDto details = response
                .retryWhen(support.retrySpec())
                .block();
        ...
        List<TransactionResponseDto> transactions = details.transactions() == null
                ? List.of()
    ...
    public List<TransactionResponseDto> getTransactions(String type, UUID accountId) {
        Mono<List<org.nikitakapustkin.bank.contracts.dto.response.TransactionResponseDto>> response = webClient.get()
        ...
        List<org.nikitakapustkin.bank.contracts.dto.response.TransactionResponseDto> transactions = response
                .retryWhen(support.retrySpec())
                .block();
