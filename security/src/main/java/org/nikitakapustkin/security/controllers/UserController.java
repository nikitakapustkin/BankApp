...
public class UserController {
    ...
    public ResponseEntity<Void> createFriends(@Valid @RequestBody FriendRequestDto friendRequest, Authentication authentication) {
    ...
    public ResponseEntity<Void> deleteFriends(@Valid @RequestBody FriendRequestDto friendRequest, Authentication authentication) {
        UUID ownerId = requireUserId(authentication);
