...
public class AccountController {
    ...
    public ResponseEntity<Void> deposit(@PathVariable(name = "accountId") UUID accountId,
    ...
    public ResponseEntity<Void> withdraw(@PathVariable(name = "accountId") UUID accountId,
    ...
    public ResponseEntity<Void> transfer(@PathVariable(name = "fromAccountId") UUID fromAccountId,
    ...
    public ResponseEntity<AccountResponseDto> getUserAccount(@PathVariable("accountId") UUID accountId, Authentication authentication) {
        UUID userId = requireUserId(authentication);
    ...
    public ResponseEntity<List<AccountResponseDto>> getAccountsByUserId(@PathVariable("userId") UUID userId) {
