...
class EventIngestionServiceTest {
    ...
    @Mock
    private UserEventRepositoryPort userEventRepository;
    @Mock
    private AccountEventRepositoryPort accountEventRepository;
    @Mock
    private TransactionEventRepositoryPort transactionEventRepository;
