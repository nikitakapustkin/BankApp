...
class EventContractTest {
    ...
    void producer_event_message_is_compatible_with_event_envelope() throws Exception {
        ...
        EventEnvelope<AccountCreatedPayload> message = new EventEnvelope<>(
                eventId,
        ...
        EventEnvelope<AccountCreatedPayload> dto = mapper.readValue(
                json,
            new TypeReference<>() {
            }
        );
    ...
    void producer_transaction_message_is_compatible_with_event_envelope() throws Exception {
        ...
        EventEnvelope<TransactionCreatedPayload> message = new EventEnvelope<>(
                transactionId,
        ...
        String json = mapper.writeValueAsString(message);
        EventEnvelope<TransactionCreatedPayload> dto = mapper.readValue(
                json,
                new TypeReference<>() {
                }
        );
