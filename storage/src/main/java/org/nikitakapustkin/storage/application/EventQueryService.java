...
public class EventQueryService {
  ...
  public List<StorageEventResponseDto> getEvents(
    ...
    List<StorageEventResponseDto> events =
        switch (normalizedSource) {
          ...
          case "TRANSACTION" ->
              fetchTransactionEvents(
                  normalizedEventType, entityId, correlationId, transactionTypeEnum, page);
          default ->
              mergeAllSources(
                  normalizedEventType,
                  entityId,
  ...
  private List<StorageEventResponseDto> fetchUserEvents(
      String eventType, UUID userId, UUID correlationId, PageRequest page) {
  ...
  private List<StorageEventResponseDto> fetchAccountEvents(
      String eventType, UUID accountId, UUID correlationId, PageRequest page) {
  ...
  private List<StorageEventResponseDto> fetchTransactionEvents(
    ...
    return transactionEventRepository
        .findEvents(eventType, accountId, correlationId, transactionType, page)
        .stream()
  ...
  private List<StorageEventResponseDto> mergeAllSources(
    ...
    var transaction =
        fetchTransactionEvents(eventType, entityId, correlationId, transactionType, page);
