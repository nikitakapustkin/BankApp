...
public class UserPersistenceAdapter implements LoadUserPort, LoadUsersPort, LoadFriendsPort, CreateUserPort, UpdateFriendsPort, DeleteUserPort {
    ...
    public void addFriend(UUID userId, UUID friendId) {
        ...
        var friend = users.findById(friendId)
