...
public class OutboxDomainEventPublisherAdapter
  ...
  private static FriendAddedPayload toFriendAddedPayload(DomainEvent event) {
    ...
    return new FriendAddedPayload(data.userId(), data.friendId(), data.description());
  }
  ...
  private static FriendRemovedPayload toFriendRemovedPayload(DomainEvent event) {
    ...
    return new FriendRemovedPayload(data.userId(), data.friendId(), data.description());
  }
  ...
  private static AccountCreatedPayload toAccountCreatedPayload(DomainEvent event) {
    ...
    return new AccountCreatedPayload(
        data.accountId(), data.ownerId(), data.ownerLogin(), data.description());
  }
  ...
  private static AccountDepositedPayload toAccountDepositedPayload(DomainEvent event) {
    ...
    return new AccountDepositedPayload(data.accountId(), data.amount(), data.description());
  }
  ...
  private static AccountWithdrawnPayload toAccountWithdrawnPayload(DomainEvent event) {
    ...
    return new AccountWithdrawnPayload(data.accountId(), data.amount(), data.description());
  }
  ...
  private static TransferDirection toContractDirection(
      org.nikitakapustkin.domain.events.payload.TransferDirection direction) {
    if (direction == null) {
      return null;
    }
  ...
  private static HairColor toContractHairColor(
