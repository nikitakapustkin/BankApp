    ...
    protected void doFilterInternal(
        ...
        if (header != null && header.startsWith("Bearer ")) {
            ...
            try {
                ...
                log.debug("JWT validation failed for {} {}", request.getMethod(), request.getRequestURI(), ex);
            }
        }
        filterChain.doFilter(request, response);
    }

    private static @NonNull UsernamePasswordAuthenticationToken getUsernamePasswordAuthenticationToken(String role, String username, UUID userId) {
