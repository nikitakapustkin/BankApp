...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAlreadyExists(UserAlreadyExistsException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<ApiError> handleNotEnoughMoney(NotEnoughMoneyException ex, HttpServletRequest req) {
    ...
    public ResponseEntity<ApiError> handleOptimisticLock(OptimisticLockingFailureException ex, HttpServletRequest req) {
        return build(HttpStatus.CONFLICT, ErrorCode.CONCURRENT_UPDATE,
                "Concurrent update detected. Please retry the request.", req);
    }

    @ExceptionHandler({
            UserHasNoFriendsException.class,
    ...
    public ResponseEntity<ApiError> handleUnexpected(Exception ex, HttpServletRequest req) {
        ...
        return build(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.INTERNAL_ERROR,
                "Internal server error (id=" + errorId + ")", req);
    }

    private ResponseEntity<ApiError> build(HttpStatus status, ErrorCode error, String message, HttpServletRequest req) {
        ApiError body = new ApiError(
                Instant.now(),
                status.value(),
                error,
