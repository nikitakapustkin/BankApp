...
public class AccountController {
    ...
    public ResponseEntity<List<AccountResponseDto>> getAccounts(@RequestParam(required = false, name = "userId") UUID userId) {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<AccountResponseDto> createAccount(@RequestBody @Valid CreateAccountRequestDto dto) {
    ...
    @Transactional(readOnly = true)
    public ResponseEntity<AccountDetailsResponseDto> getAccount(@PathVariable("accountId") UUID accountId) {
    ...
    public ResponseEntity<BigDecimal> getBalance(
            @Parameter(description = "ID of the account", example = "123e4567-e89b-12d3-a456-426614174000")
