...
/**
 * Exception thrown when a user has no friends.
 * This exception is used when an operation is attempted that requires a user to have friends but they do not have any.
 */
