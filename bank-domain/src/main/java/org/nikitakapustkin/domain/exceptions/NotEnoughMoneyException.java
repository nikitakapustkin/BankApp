...
/**
 * Exception thrown when there is not enough money for a transaction.
 * This exception is used when a user attempts a transaction that exceeds their available balance.
 */
